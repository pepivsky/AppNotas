...
public class MainActivity extends AppCompatActivity implements NotesListener { //Video 10 terminado (empezar el 11)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EditText inputSearch = findViewById(R.id.edtSearch);
